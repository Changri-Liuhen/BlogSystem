...
import com.example.blogsystem.dao.BlogConfigMapper;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteName = "BlogSystem";
    public static final String websiteDescription = "基于SpringBoot+Thymeleaf+Mybatis的个人博客网站";
    public static final String websiteLogo = "/admin/dist/img/blog.png";
    public static final String websiteIcon = "/admin/dist/img/blog.png";

    public static final String yourAvatar = "/admin/dist/img/Changri-Liuhen.jpg";
    public static final String yourEmail = "180400102@stu.hit.edu.cn";
    public static final String yourName = "杜瀚跃";

    public static final String footerAbout = "BlogSystem";
    public static final String footerICP = "ICP Number";
    public static final String footerCopyRight = "@2021 Du-hy";
    public static final String footerPoweredBy = "BlogSystem";
