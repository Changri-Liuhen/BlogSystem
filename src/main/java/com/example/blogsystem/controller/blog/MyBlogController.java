package com.example.blogsystem.controller.blog;

import com.example.blogsystem.controller.vo.BlogDetailVO;
import com.example.blogsystem.entity.BlogComment;
import com.example.blogsystem.entity.BlogLink;
import com.example.blogsystem.service.*;
import com.example.blogsystem.util.*;
...
public class MyBlogController {
    ...
    public String link(HttpServletRequest request) {
        ...
        if (linkMap != null) {
            //判断链接类别并封装数据 0-我喜欢的链接 1-推荐 2-个人网站
