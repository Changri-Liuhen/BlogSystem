/*
create database `db_myblog` default character set utf8mb4 collate utf8mb4_0900_ai_ci;
use db_myblog;
...
insert  into `tb_admin_user`(`admin_user_id`,`login_user_name`,`login_password`,`nick_name`,`locked`) values (1,'admin','e10adc3949ba59abbe56e057f20f883e','duhy',0);
